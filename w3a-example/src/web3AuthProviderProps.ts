...
const openloginAdapter = new OpenloginAdapter({
  ...
  adapterSettings: {
    ...
    loginConfig: {
      google: { name: "google", showOnModal: false }, // Disable Google login
      facebook: { showOnModal: false }, // Disable Facebook login
      twitter: { showOnModal: false }, // Disable Twitter login
      reddit: { showOnModal: false }, // Disable Reddit login
      discord: { showOnModal: false }, // Disable Discord login
    },
    mfaSettings: {
      deviceShareFactor: {
        enable: true,
